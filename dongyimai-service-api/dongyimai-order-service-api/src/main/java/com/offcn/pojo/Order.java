...
public class Order implements Serializable{
	...
	@ApiModelProperty(value = "商家要提交的商品id",required = false)
	@TableField(exist = false) //因为数据库表中没有该属性
	private String[] itemIdes;

	public String[] getItemIdes() {
		return itemIdes;
	}

	public void setItemIdes(String[] itemIdes) {
		this.itemIdes = itemIdes;
	}
