...
//    }
     ...
     * @return
     */
    @ApiOperation(value = "ItemCats添加",notes = "添加ItemCats方法详情",tags = {"ItemCatController"})
    @PostMapping
    public Result addItemCat(@RequestBody @ApiParam(name = "ItemCats对象",value = "传入JSON数据",required = true) ItemCats itemCats){
        itemCatService.addItemCat(itemCats);
        return new Result(true,StatusCode.OK,"添加成功111");
    }
}
